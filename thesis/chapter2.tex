...
%%%%%%%%%%% SHOULD I ADD?
%%%%%%%%%%%%%%%%%%%%%% utxo and account architecture overview?
%%%%%%%%%%%%%%%%%%%%%% containerization overview?
%%%%%%%%%%%%%%%%%%%%%% Is the related work section enough or relevant?
%%%%%%%%%%%%%%%%% should i keep the table here ?
...
\section{Related work} \label{ch2_relatedWork}
...
\subsection{Solana}
Solana represents a third-generation blockchain designed specifically to maximize throughput without sharding the system. It introduces an architectural design that aims to remove the performance bottlenecks found in Bitcoin and Ethereum.
...
\begin{itemize}
    ...
    \item \textbf{Pipeline Architecture:} Unlike the sequential processing in older chains, Solana utilizes a concept called Pipelining, which allows transaction validation to be parallelized across GPU cores. This enables theoretical throughputs exceeding 50,000 TPS \cite{yakovenko2018poh}.
\end{itemize}
