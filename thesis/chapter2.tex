...
This chapter demonstrates the theoretical foundations necessary for the development of the proposed educational blockchain system. It presents an overview of Distributed Ledger Technology (DLT), examines the cryptographic primitives that ensure data integrity and authentication on the blockchain, and provides a technical foundation and an overview of the major consensus algorithms. Furthermore, this chapter explores these theoretical concepts through an analysis of existing blockchain implementations—including Bitcoin, Ethereum, and Solana to showcase the practical trade-offs between security, scalability, and decentralization in such systems.
...
Despite the robust cryptographic foundations, distributed systems face unique attack vectors inherent to their decentralized nature. Understanding these risks is essential for the design of the blockchain system we will discussed in Chapter \ref{ch3_design}.
...
\section{Related work} \label{ch2_implementations}

To understand the practical application of the consensus mechanisms and data systems discussed previously, in this section we focus on investigating the existing works and show three blockchain architectures: Bitcoin, Ethereum, and Solana. Each represents a distinct approach to solving the Blockchain Trilemma \cite{buterin2018trilemma}.
