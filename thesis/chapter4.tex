...
\begin{itemize}
    ...
    \item \textbf{Frontend:} \textit{Vue.js} is employed to power the Blockchain Explorer, providing a user interface that visualizes block propagation, validators, and mempool status~\cite{vuejs}.
...
The \texttt{AccountModel} class (\texttt{blockchain/transaction/account\_model.py}), shown in the code snippet Listing~\ref{lst:account_model}, maintains the global state of user balances. \\\textbf{Data Persistence Note:}
