...
\begin{itemize}
    \item \textbf{Scaffolding Approach:} By providing starter code, which abstracts concepts such as P2P networking in Module 1 and consensus mechanisms in Module 2, students were allowed to focus on the logic of the blockchain task they were attempting to solve.
